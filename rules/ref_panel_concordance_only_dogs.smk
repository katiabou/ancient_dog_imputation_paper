...
rule remove_sample_indels_multiallelic_snps_concordance_only_dogs:
    ...
    output:
        ref_sample_snp = temp('{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp.phased.vcf.gz')
    log:
        '{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp.phased.log'
    threads: 4
    benchmark:
...
rule fill_tags_concordance_only_dogs:
    ...
    """
    input:
        ref_sample_snp = '{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp.phased.vcf.gz'
    output:
        ref_sample_snp_filltags = temp('{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp_filltags.phased.vcf.gz')
    log:
        '{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp_filltags.phased.log'
    threads: 4
    benchmark:
...
rule filter_sites_concordance_only_dogs:
    ...
    """
    input:
        ref_sample_snp_filltags = '{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp_filltags.phased.vcf.gz'
    output:
        ...
        ref_sample_snp_filltags_filter_tbi = '{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp_filltags_filter.phased.vcf.gz.tbi'
    params:
        f_missing = config['F_MISSING']
    log:
        '{path}/output/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp_filltags_filter.phased.log'
    threads: 4
    benchmark:
        '{path}/benchmarks/reference_panel_only_dogs/ref-panel_{chrom}_sample-snp_filltags_filter.phased.tsv'
    shell:
        '''
